...
3. Copy the content of the JSON of the repository [Text Changes for SPAs](https://github.com/luis-colman/Re-arrage-Extension-for-SPAs/blob/master/config.json).
...
10. Select the type of re-arrangement you want to perform (before, after, at the beginning of, at the end of).
